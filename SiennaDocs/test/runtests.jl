...
import Aqua
Aqua.test_unbound_args(SiennaDocs)
Aqua.test_undefined_exports(SiennaDocs)
Aqua.test_ambiguities(SiennaDocs)
Aqua.test_stale_deps(SiennaDocs)
Aqua.test_deps_compat(SiennaDocs)
